    ...
    for factor_index, factor in enumerate(extraction.target_factors):
        ...
        specs.append(
            FactorResearchSpec(
                ...
                preprocessing=list(factor.preprocessing_rules),
                neutralization=list(factor.neutralization_rules),
                ...
                metadata={
                    ...
                    "data_requirements": {
                        ...
                        "preprocessing_required_fields": list(factor.preprocessing_required_fields),
                        "neutralization_required_fields": list(factor.neutralization_required_fields),
                        "evaluation_required_fields": list(factor.evaluation_required_fields),
                    },
